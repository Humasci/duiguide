# Fulton County, GA - Research Checklist
...
- [ ] Query 1: `Fulton GA jail release hours cash only blackout times`
- [ ] Query 2: `site:.gov "Fulton" "inmate handbook" OR "release hours" filetype:pdf`
- [ ] Query 3: `site:.gov "Fulton" sheriff "bonding" OR "bail posting" hours`
...
- [ ] Query 1: `site:.gov "Fulton" GA "bond schedule" OR "bail schedule" filetype:pdf`
- [ ] Query 2: `"Fulton" GA DWI DUI bail amount first offense`
- [ ] Query 3: `"Fulton" GA magistrate "bond schedule" 2024 2025`
...
- [ ] Query 1: `"Fulton" GA vehicle impound release notarized letter power of attorney`
- [ ] Query 2: `site:.gov "Fulton" "vehicle storage facility" release requirements`
- [ ] Query 3: `"Fulton" GA towing fees maximum cap ordinance`
...
- [ ] Query 1: `"Fulton" GA courthouse parking juror lot free shuttle`
- [ ] Query 2: `site:.gov "Fulton" "jury service" parking map`
- [ ] Query 3: `"Fulton" GA court "dress code" OR "prohibited items"`
...
### 5. Local Court Rules
- [ ] Query 1: `site:.gov "Fulton" court "local rules" OR "standing order" filetype:pdf`
- [ ] Query 2: `"Fulton" GA "administrative order" zoom virtual hearing`
