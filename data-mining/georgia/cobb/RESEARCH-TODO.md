# Cobb County, GA - Research Checklist
...
- [ ] Query 1: `Cobb GA jail release hours cash only blackout times`
- [ ] Query 2: `site:.gov "Cobb" "inmate handbook" OR "release hours" filetype:pdf`
- [ ] Query 3: `site:.gov "Cobb" sheriff "bonding" OR "bail posting" hours`
...
- [ ] Query 1: `site:.gov "Cobb" GA "bond schedule" OR "bail schedule" filetype:pdf`
- [ ] Query 2: `"Cobb" GA DWI DUI bail amount first offense`
- [ ] Query 3: `"Cobb" GA magistrate "bond schedule" 2024 2025`
...
- [ ] Query 1: `"Cobb" GA vehicle impound release notarized letter power of attorney`
- [ ] Query 2: `site:.gov "Cobb" "vehicle storage facility" release requirements`
- [ ] Query 3: `"Cobb" GA towing fees maximum cap ordinance`
...
- [ ] Query 1: `"Cobb" GA courthouse parking juror lot free shuttle`
- [ ] Query 2: `site:.gov "Cobb" "jury service" parking map`
- [ ] Query 3: `"Cobb" GA court "dress code" OR "prohibited items"`
...
### 5. Local Court Rules
- [ ] Query 1: `site:.gov "Cobb" court "local rules" OR "standing order" filetype:pdf`
- [ ] Query 2: `"Cobb" GA "administrative order" zoom virtual hearing`
