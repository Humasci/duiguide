# Gwinnett County, GA - Research Checklist
...
- [ ] Query 1: `Gwinnett GA jail release hours cash only blackout times`
- [ ] Query 2: `site:.gov "Gwinnett" "inmate handbook" OR "release hours" filetype:pdf`
- [ ] Query 3: `site:.gov "Gwinnett" sheriff "bonding" OR "bail posting" hours`
...
- [ ] Query 1: `site:.gov "Gwinnett" GA "bond schedule" OR "bail schedule" filetype:pdf`
- [ ] Query 2: `"Gwinnett" GA DWI DUI bail amount first offense`
- [ ] Query 3: `"Gwinnett" GA magistrate "bond schedule" 2024 2025`
...
- [ ] Query 1: `"Gwinnett" GA vehicle impound release notarized letter power of attorney`
- [ ] Query 2: `site:.gov "Gwinnett" "vehicle storage facility" release requirements`
- [ ] Query 3: `"Gwinnett" GA towing fees maximum cap ordinance`
...
- [ ] Query 1: `"Gwinnett" GA courthouse parking juror lot free shuttle`
- [ ] Query 2: `site:.gov "Gwinnett" "jury service" parking map`
- [ ] Query 3: `"Gwinnett" GA court "dress code" OR "prohibited items"`
...
### 5. Local Court Rules
- [ ] Query 1: `site:.gov "Gwinnett" court "local rules" OR "standing order" filetype:pdf`
- [ ] Query 2: `"Gwinnett" GA "administrative order" zoom virtual hearing`
