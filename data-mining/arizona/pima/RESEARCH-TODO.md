# Pima County, AZ - Research Checklist
...
- [ ] Query 1: `Pima AZ jail release hours cash only blackout times`
- [ ] Query 2: `site:.gov "Pima" "inmate handbook" OR "release hours" filetype:pdf`
- [ ] Query 3: `site:.gov "Pima" sheriff "bonding" OR "bail posting" hours`
...
- [ ] Query 1: `site:.gov "Pima" AZ "bond schedule" OR "bail schedule" filetype:pdf`
- [ ] Query 2: `"Pima" AZ DWI DUI bail amount first offense`
- [ ] Query 3: `"Pima" AZ magistrate "bond schedule" 2024 2025`
...
- [ ] Query 1: `"Pima" AZ vehicle impound release notarized letter power of attorney`
- [ ] Query 2: `site:.gov "Pima" "vehicle storage facility" release requirements`
- [ ] Query 3: `"Pima" AZ towing fees maximum cap ordinance`
...
- [ ] Query 1: `"Pima" AZ courthouse parking juror lot free shuttle`
- [ ] Query 2: `site:.gov "Pima" "jury service" parking map`
- [ ] Query 3: `"Pima" AZ court "dress code" OR "prohibited items"`
...
### 5. Local Court Rules
- [ ] Query 1: `site:.gov "Pima" court "local rules" OR "standing order" filetype:pdf`
- [ ] Query 2: `"Pima" AZ "administrative order" zoom virtual hearing`
