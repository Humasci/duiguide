# Maricopa County, AZ - Research Checklist
...
- [ ] Query 1: `Maricopa AZ jail release hours cash only blackout times`
- [ ] Query 2: `site:.gov "Maricopa" "inmate handbook" OR "release hours" filetype:pdf`
- [ ] Query 3: `site:.gov "Maricopa" sheriff "bonding" OR "bail posting" hours`
...
- [ ] Query 1: `site:.gov "Maricopa" AZ "bond schedule" OR "bail schedule" filetype:pdf`
- [ ] Query 2: `"Maricopa" AZ DWI DUI bail amount first offense`
- [ ] Query 3: `"Maricopa" AZ magistrate "bond schedule" 2024 2025`
...
- [ ] Query 1: `"Maricopa" AZ vehicle impound release notarized letter power of attorney`
- [ ] Query 2: `site:.gov "Maricopa" "vehicle storage facility" release requirements`
- [ ] Query 3: `"Maricopa" AZ towing fees maximum cap ordinance`
...
- [ ] Query 1: `"Maricopa" AZ courthouse parking juror lot free shuttle`
- [ ] Query 2: `site:.gov "Maricopa" "jury service" parking map`
- [ ] Query 3: `"Maricopa" AZ court "dress code" OR "prohibited items"`
...
### 5. Local Court Rules
- [ ] Query 1: `site:.gov "Maricopa" court "local rules" OR "standing order" filetype:pdf`
- [ ] Query 2: `"Maricopa" AZ "administrative order" zoom virtual hearing`
