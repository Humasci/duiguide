# Denver County, CO - Research Checklist
...
- [ ] Query 1: `Denver CO jail release hours cash only blackout times`
- [ ] Query 2: `site:.gov "Denver" "inmate handbook" OR "release hours" filetype:pdf`
- [ ] Query 3: `site:.gov "Denver" sheriff "bonding" OR "bail posting" hours`
...
- [ ] Query 1: `site:.gov "Denver" CO "bond schedule" OR "bail schedule" filetype:pdf`
- [ ] Query 2: `"Denver" CO DWI DUI bail amount first offense`
- [ ] Query 3: `"Denver" CO magistrate "bond schedule" 2024 2025`
...
- [ ] Query 1: `"Denver" CO vehicle impound release notarized letter power of attorney`
- [ ] Query 2: `site:.gov "Denver" "vehicle storage facility" release requirements`
- [ ] Query 3: `"Denver" CO towing fees maximum cap ordinance`
...
- [ ] Query 1: `"Denver" CO courthouse parking juror lot free shuttle`
- [ ] Query 2: `site:.gov "Denver" "jury service" parking map`
- [ ] Query 3: `"Denver" CO court "dress code" OR "prohibited items"`
...
### 5. Local Court Rules
- [ ] Query 1: `site:.gov "Denver" court "local rules" OR "standing order" filetype:pdf`
- [ ] Query 2: `"Denver" CO "administrative order" zoom virtual hearing`
