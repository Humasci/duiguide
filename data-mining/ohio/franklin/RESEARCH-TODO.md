# Franklin County, OH - Research Checklist
...
- [ ] Query 1: `Franklin OH jail release hours cash only blackout times`
- [ ] Query 2: `site:.gov "Franklin" "inmate handbook" OR "release hours" filetype:pdf`
- [ ] Query 3: `site:.gov "Franklin" sheriff "bonding" OR "bail posting" hours`
...
- [ ] Query 1: `site:.gov "Franklin" OH "bond schedule" OR "bail schedule" filetype:pdf`
- [ ] Query 2: `"Franklin" OH DWI DUI bail amount first offense`
- [ ] Query 3: `"Franklin" OH magistrate "bond schedule" 2024 2025`
...
- [ ] Query 1: `"Franklin" OH vehicle impound release notarized letter power of attorney`
- [ ] Query 2: `site:.gov "Franklin" "vehicle storage facility" release requirements`
- [ ] Query 3: `"Franklin" OH towing fees maximum cap ordinance`
...
- [ ] Query 1: `"Franklin" OH courthouse parking juror lot free shuttle`
- [ ] Query 2: `site:.gov "Franklin" "jury service" parking map`
- [ ] Query 3: `"Franklin" OH court "dress code" OR "prohibited items"`
...
### 5. Local Court Rules
- [ ] Query 1: `site:.gov "Franklin" court "local rules" OR "standing order" filetype:pdf`
- [ ] Query 2: `"Franklin" OH "administrative order" zoom virtual hearing`
