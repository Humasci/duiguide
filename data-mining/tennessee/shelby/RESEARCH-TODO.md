# Shelby County, TN - Research Checklist
...
- [ ] Query 1: `Shelby TN jail release hours cash only blackout times`
- [ ] Query 2: `site:.gov "Shelby" "inmate handbook" OR "release hours" filetype:pdf`
- [ ] Query 3: `site:.gov "Shelby" sheriff "bonding" OR "bail posting" hours`
...
- [ ] Query 1: `site:.gov "Shelby" TN "bond schedule" OR "bail schedule" filetype:pdf`
- [ ] Query 2: `"Shelby" TN DWI DUI bail amount first offense`
- [ ] Query 3: `"Shelby" TN magistrate "bond schedule" 2024 2025`
...
- [ ] Query 1: `"Shelby" TN vehicle impound release notarized letter power of attorney`
- [ ] Query 2: `site:.gov "Shelby" "vehicle storage facility" release requirements`
- [ ] Query 3: `"Shelby" TN towing fees maximum cap ordinance`
...
- [ ] Query 1: `"Shelby" TN courthouse parking juror lot free shuttle`
- [ ] Query 2: `site:.gov "Shelby" "jury service" parking map`
- [ ] Query 3: `"Shelby" TN court "dress code" OR "prohibited items"`
...
### 5. Local Court Rules
- [ ] Query 1: `site:.gov "Shelby" court "local rules" OR "standing order" filetype:pdf`
- [ ] Query 2: `"Shelby" TN "administrative order" zoom virtual hearing`
