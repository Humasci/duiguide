# Davidson County, TN - Research Checklist
...
- [ ] Query 1: `Davidson TN jail release hours cash only blackout times`
- [ ] Query 2: `site:.gov "Davidson" "inmate handbook" OR "release hours" filetype:pdf`
- [ ] Query 3: `site:.gov "Davidson" sheriff "bonding" OR "bail posting" hours`
...
- [ ] Query 1: `site:.gov "Davidson" TN "bond schedule" OR "bail schedule" filetype:pdf`
- [ ] Query 2: `"Davidson" TN DWI DUI bail amount first offense`
- [ ] Query 3: `"Davidson" TN magistrate "bond schedule" 2024 2025`
...
- [ ] Query 1: `"Davidson" TN vehicle impound release notarized letter power of attorney`
- [ ] Query 2: `site:.gov "Davidson" "vehicle storage facility" release requirements`
- [ ] Query 3: `"Davidson" TN towing fees maximum cap ordinance`
...
- [ ] Query 1: `"Davidson" TN courthouse parking juror lot free shuttle`
- [ ] Query 2: `site:.gov "Davidson" "jury service" parking map`
- [ ] Query 3: `"Davidson" TN court "dress code" OR "prohibited items"`
...
### 5. Local Court Rules
- [ ] Query 1: `site:.gov "Davidson" court "local rules" OR "standing order" filetype:pdf`
- [ ] Query 2: `"Davidson" TN "administrative order" zoom virtual hearing`
