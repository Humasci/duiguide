# Knox County, TN - Research Checklist
...
- [ ] Query 1: `Knox TN jail release hours cash only blackout times`
- [ ] Query 2: `site:.gov "Knox" "inmate handbook" OR "release hours" filetype:pdf`
- [ ] Query 3: `site:.gov "Knox" sheriff "bonding" OR "bail posting" hours`
...
- [ ] Query 1: `site:.gov "Knox" TN "bond schedule" OR "bail schedule" filetype:pdf`
- [ ] Query 2: `"Knox" TN DWI DUI bail amount first offense`
- [ ] Query 3: `"Knox" TN magistrate "bond schedule" 2024 2025`
...
- [ ] Query 1: `"Knox" TN vehicle impound release notarized letter power of attorney`
- [ ] Query 2: `site:.gov "Knox" "vehicle storage facility" release requirements`
- [ ] Query 3: `"Knox" TN towing fees maximum cap ordinance`
...
- [ ] Query 1: `"Knox" TN courthouse parking juror lot free shuttle`
- [ ] Query 2: `site:.gov "Knox" "jury service" parking map`
- [ ] Query 3: `"Knox" TN court "dress code" OR "prohibited items"`
...
### 5. Local Court Rules
- [ ] Query 1: `site:.gov "Knox" court "local rules" OR "standing order" filetype:pdf`
- [ ] Query 2: `"Knox" TN "administrative order" zoom virtual hearing`
