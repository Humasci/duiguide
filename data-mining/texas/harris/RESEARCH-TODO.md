# Harris County, TX - Research Checklist
...
- [ ] Query 1: `Harris TX jail release hours cash only blackout times`
- [ ] Query 2: `site:.gov "Harris" "inmate handbook" OR "release hours" filetype:pdf`
- [ ] Query 3: `site:.gov "Harris" sheriff "bonding" OR "bail posting" hours`
...
- [ ] Query 1: `site:.gov "Harris" TX "bond schedule" OR "bail schedule" filetype:pdf`
- [ ] Query 2: `"Harris" TX DWI DUI bail amount first offense`
- [ ] Query 3: `"Harris" TX magistrate "bond schedule" 2024 2025`
...
- [ ] Query 1: `"Harris" TX vehicle impound release notarized letter power of attorney`
- [ ] Query 2: `site:.gov "Harris" "vehicle storage facility" release requirements`
- [ ] Query 3: `"Harris" TX towing fees maximum cap ordinance`
...
- [ ] Query 1: `"Harris" TX courthouse parking juror lot free shuttle`
- [ ] Query 2: `site:.gov "Harris" "jury service" parking map`
- [ ] Query 3: `"Harris" TX court "dress code" OR "prohibited items"`
...
### 5. Local Court Rules
- [ ] Query 1: `site:.gov "Harris" court "local rules" OR "standing order" filetype:pdf`
- [ ] Query 2: `"Harris" TX "administrative order" zoom virtual hearing`
