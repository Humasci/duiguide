# Tarrant County, TX - Research Checklist
...
- [ ] Query 1: `Tarrant TX jail release hours cash only blackout times`
- [ ] Query 2: `site:.gov "Tarrant" "inmate handbook" OR "release hours" filetype:pdf`
- [ ] Query 3: `site:.gov "Tarrant" sheriff "bonding" OR "bail posting" hours`
...
- [ ] Query 1: `site:.gov "Tarrant" TX "bond schedule" OR "bail schedule" filetype:pdf`
- [ ] Query 2: `"Tarrant" TX DWI DUI bail amount first offense`
- [ ] Query 3: `"Tarrant" TX magistrate "bond schedule" 2024 2025`
...
- [ ] Query 1: `"Tarrant" TX vehicle impound release notarized letter power of attorney`
- [ ] Query 2: `site:.gov "Tarrant" "vehicle storage facility" release requirements`
- [ ] Query 3: `"Tarrant" TX towing fees maximum cap ordinance`
...
- [ ] Query 1: `"Tarrant" TX courthouse parking juror lot free shuttle`
- [ ] Query 2: `site:.gov "Tarrant" "jury service" parking map`
- [ ] Query 3: `"Tarrant" TX court "dress code" OR "prohibited items"`
...
### 5. Local Court Rules
- [ ] Query 1: `site:.gov "Tarrant" court "local rules" OR "standing order" filetype:pdf`
- [ ] Query 2: `"Tarrant" TX "administrative order" zoom virtual hearing`
