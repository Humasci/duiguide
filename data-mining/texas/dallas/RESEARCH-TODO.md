# Dallas County, TX - Research Checklist
...
- [ ] Query 1: `Dallas TX jail release hours cash only blackout times`
- [ ] Query 2: `site:.gov "Dallas" "inmate handbook" OR "release hours" filetype:pdf`
- [ ] Query 3: `site:.gov "Dallas" sheriff "bonding" OR "bail posting" hours`
...
- [ ] Query 1: `site:.gov "Dallas" TX "bond schedule" OR "bail schedule" filetype:pdf`
- [ ] Query 2: `"Dallas" TX DWI DUI bail amount first offense`
- [ ] Query 3: `"Dallas" TX magistrate "bond schedule" 2024 2025`
...
- [ ] Query 1: `"Dallas" TX vehicle impound release notarized letter power of attorney`
- [ ] Query 2: `site:.gov "Dallas" "vehicle storage facility" release requirements`
- [ ] Query 3: `"Dallas" TX towing fees maximum cap ordinance`
...
- [ ] Query 1: `"Dallas" TX courthouse parking juror lot free shuttle`
- [ ] Query 2: `site:.gov "Dallas" "jury service" parking map`
- [ ] Query 3: `"Dallas" TX court "dress code" OR "prohibited items"`
...
### 5. Local Court Rules
- [ ] Query 1: `site:.gov "Dallas" court "local rules" OR "standing order" filetype:pdf`
- [ ] Query 2: `"Dallas" TX "administrative order" zoom virtual hearing`
