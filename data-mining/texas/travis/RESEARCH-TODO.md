# Travis County, TX - Research Checklist
...
- [ ] Query 1: `Travis TX jail release hours cash only blackout times`
- [ ] Query 2: `site:.gov "Travis" "inmate handbook" OR "release hours" filetype:pdf`
- [ ] Query 3: `site:.gov "Travis" sheriff "bonding" OR "bail posting" hours`
...
- [ ] Query 1: `site:.gov "Travis" TX "bond schedule" OR "bail schedule" filetype:pdf`
- [ ] Query 2: `"Travis" TX DWI DUI bail amount first offense`
- [ ] Query 3: `"Travis" TX magistrate "bond schedule" 2024 2025`
...
- [ ] Query 1: `"Travis" TX vehicle impound release notarized letter power of attorney`
- [ ] Query 2: `site:.gov "Travis" "vehicle storage facility" release requirements`
- [ ] Query 3: `"Travis" TX towing fees maximum cap ordinance`
...
- [ ] Query 1: `"Travis" TX courthouse parking juror lot free shuttle`
- [ ] Query 2: `site:.gov "Travis" "jury service" parking map`
- [ ] Query 3: `"Travis" TX court "dress code" OR "prohibited items"`
...
### 5. Local Court Rules
- [ ] Query 1: `site:.gov "Travis" court "local rules" OR "standing order" filetype:pdf`
- [ ] Query 2: `"Travis" TX "administrative order" zoom virtual hearing`
