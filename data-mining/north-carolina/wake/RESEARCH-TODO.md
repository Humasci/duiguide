# Wake County, NC - Research Checklist
...
- [ ] Query 1: `Wake NC jail release hours cash only blackout times`
- [ ] Query 2: `site:.gov "Wake" "inmate handbook" OR "release hours" filetype:pdf`
- [ ] Query 3: `site:.gov "Wake" sheriff "bonding" OR "bail posting" hours`
...
- [ ] Query 1: `site:.gov "Wake" NC "bond schedule" OR "bail schedule" filetype:pdf`
- [ ] Query 2: `"Wake" NC DWI DUI bail amount first offense`
- [ ] Query 3: `"Wake" NC magistrate "bond schedule" 2024 2025`
...
- [ ] Query 1: `"Wake" NC vehicle impound release notarized letter power of attorney`
- [ ] Query 2: `site:.gov "Wake" "vehicle storage facility" release requirements`
- [ ] Query 3: `"Wake" NC towing fees maximum cap ordinance`
...
- [ ] Query 1: `"Wake" NC courthouse parking juror lot free shuttle`
- [ ] Query 2: `site:.gov "Wake" "jury service" parking map`
- [ ] Query 3: `"Wake" NC court "dress code" OR "prohibited items"`
...
### 5. Local Court Rules
- [ ] Query 1: `site:.gov "Wake" court "local rules" OR "standing order" filetype:pdf`
- [ ] Query 2: `"Wake" NC "administrative order" zoom virtual hearing`
