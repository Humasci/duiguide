# Collin County, TX - Hunter-Killer v2.0 Research Checklist
...
```
site:.gov "sheriff" "towing" OR "impound" "release procedure" filetype:pdf Collin TX
```
...
```
site:.gov "towing" "fee schedule" "after hours" OR "holiday" Plano Collin
```
...
```
site:.gov "Collin" TX "vehicle storage facility" "notarized" OR "power of attorney"
```

### IMPOUND - Fee Schedule
```
site:.gov "towing ordinance" "maximum fee" Plano TX
```
...
```
site:.gov "inmate handbook" "release processing" "shift change" Collin TX 2025
```
...
```
site:.gov "magistrate" "standing order" "DUI" OR "DWI" "release" Collin TX 2025
```
...
```
site:.gov "bail schedule" "misdemeanor" "DUI" OR "DWI" 2025 filetype:pdf Collin TX
```
...
```
site:.gov "bail schedule" "felony" "DUI" OR "DWI" 2025 filetype:pdf Collin TX
```
...
### BAIL - PR Bond Rules
```
site:.gov "personal recognizance" OR "PR bond" "DUI" eligibility Collin TX 2025
```

### BAIL - Bonding Office Hours
```
site:.gov "Collin" sheriff "bonding" hours location 2025
```
EXTRACT:
- Address
...
### DMV - Discovery Fees
```
site:.gov "open records" "fee schedule" "body cam" OR "video" Plano police 2025
```
...
```
site:.gov "ALR" "hearing location" "zoom" OR "telephonic" TX Collin 2025
```
EXTRACT:
...
```
site:.gov "probation" "approved providers" "interlock" Collin TX
```
...
```
site:.gov "interlock" "removal order" OR "verification of removal" form Collin TX
```
EXTRACT:
...
```
site:.gov "SCRAM" OR "continuous alcohol monitor" "approved" provider Collin TX
```
EXTRACT:
For each provider:
- Name
...
```
site:.gov "SCRAM violation" "probation revocation" Collin TX
```
EXTRACT:
...
```
site:.gov "pre-trial intervention" OR "diversion" "contract" OR "agreement" filetype:pdf Collin TX
```
...
### COURT - Local Rules
```
site:.gov "local rules of practice" "criminal" "cell phone" Collin clerk
```
...
### COURT - Weekend Jail
```
site:.gov "weekend jail" OR "periodic imprisonment" "application" Collin sheriff
```
...
### COURT - Parking Hack
```
site:.gov "Collin" "jury service" parking map
"Collin" TX courthouse parking juror lot free shuttle
```
