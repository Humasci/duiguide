...
```
site:.gov "inmate handbook" "release processing" "shift change" Collin TX
```
...
```
site:.gov "magistrate" "standing order" "DUI" OR "DWI" "release" Collin TX
```
...
```
site:.gov "bail schedule" "misdemeanor" "DUI" OR "DWI" 2024 OR 2025 filetype:pdf Collin TX
```
...
```
site:.gov "bail schedule" "felony" "DUI" OR "DWI" 2024 OR 2025 filetype:pdf Collin TX
```
EXTRACT:
...
### BAIL - PR Bond Rules
```
site:.gov "personal recognizance" OR "PR bond" "DUI" eligibility Collin TX
```

### BAIL - Bonding Office Hours
```
site:.gov "Collin" sheriff "bonding" hours location
```
EXTRACT:
- Address
...
### DMV - Discovery Fees
```
site:.gov "open records" "fee schedule" "body cam" OR "video" Plano police
```
...
```
site:.gov "ALR" "hearing location" "zoom" OR "telephonic" TX Collin
```
EXTRACT:
