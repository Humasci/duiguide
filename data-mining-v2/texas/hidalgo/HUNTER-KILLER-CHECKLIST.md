...
```
site:.gov "inmate handbook" "release processing" "shift change" Hidalgo TX
```
...
```
site:.gov "magistrate" "standing order" "DUI" OR "DWI" "release" Hidalgo TX
```
...
```
site:.gov "bail schedule" "misdemeanor" "DUI" OR "DWI" 2024 OR 2025 filetype:pdf Hidalgo TX
```
...
```
site:.gov "bail schedule" "felony" "DUI" OR "DWI" 2024 OR 2025 filetype:pdf Hidalgo TX
```
EXTRACT:
...
### BAIL - PR Bond Rules
```
site:.gov "personal recognizance" OR "PR bond" "DUI" eligibility Hidalgo TX
```

### BAIL - Bonding Office Hours
```
site:.gov "Hidalgo" sheriff "bonding" hours location
```
EXTRACT:
- Address
...
### DMV - Discovery Fees
```
site:.gov "open records" "fee schedule" "body cam" OR "video" McAllen police
```
...
```
site:.gov "ALR" "hearing location" "zoom" OR "telephonic" TX Hidalgo
```
EXTRACT:
