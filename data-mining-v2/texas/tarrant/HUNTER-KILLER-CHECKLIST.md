...
```
site:.gov "inmate handbook" "release processing" "shift change" Tarrant TX
```
...
```
site:.gov "magistrate" "standing order" "DUI" OR "DWI" "release" Tarrant TX
```
...
```
site:.gov "bail schedule" "misdemeanor" "DUI" OR "DWI" 2024 OR 2025 filetype:pdf Tarrant TX
```
...
```
site:.gov "bail schedule" "felony" "DUI" OR "DWI" 2024 OR 2025 filetype:pdf Tarrant TX
```
EXTRACT:
...
### BAIL - PR Bond Rules
```
site:.gov "personal recognizance" OR "PR bond" "DUI" eligibility Tarrant TX
```

### BAIL - Bonding Office Hours
```
site:.gov "Tarrant" sheriff "bonding" hours location
```
EXTRACT:
- Address
...
### DMV - Discovery Fees
```
site:.gov "open records" "fee schedule" "body cam" OR "video" Fort Worth police
```
...
```
site:.gov "ALR" "hearing location" "zoom" OR "telephonic" TX Tarrant
```
EXTRACT:
