...
```
site:.gov "inmate handbook" "release processing" "shift change" Travis TX 2025
```
...
```
site:.gov "magistrate" "standing order" "DUI" OR "DWI" "release" Travis TX 2025
```
...
```
site:.gov "bail schedule" "misdemeanor" "DUI" OR "DWI" 2025 filetype:pdf Travis TX
```
...
```
site:.gov "bail schedule" "felony" "DUI" OR "DWI" 2025 filetype:pdf Travis TX
```
...
### BAIL - PR Bond Rules
```
site:.gov "personal recognizance" OR "PR bond" "DUI" eligibility Travis TX 2025
```

### BAIL - Bonding Office Hours
```
site:.gov "Travis" sheriff "bonding" hours location 2025
```
EXTRACT:
- Address
...
### DMV - Discovery Fees
```
site:.gov "open records" "fee schedule" "body cam" OR "video" Austin police 2025
```
...
```
site:.gov "ALR" "hearing location" "zoom" OR "telephonic" TX Travis 2025
```
EXTRACT:
