...
```
site:.gov "inmate handbook" "release processing" "shift change" Harris TX
```
...
```
site:.gov "magistrate" "standing order" "DUI" OR "DWI" "release" Harris TX
```
...
```
site:.gov "bail schedule" "misdemeanor" "DUI" OR "DWI" 2024 OR 2025 filetype:pdf Harris TX
```
...
```
site:.gov "bail schedule" "felony" "DUI" OR "DWI" 2024 OR 2025 filetype:pdf Harris TX
```
EXTRACT:
...
### BAIL - PR Bond Rules
```
site:.gov "personal recognizance" OR "PR bond" "DUI" eligibility Harris TX
```

### BAIL - Bonding Office Hours
```
site:.gov "Harris" sheriff "bonding" hours location
```
EXTRACT:
- Address
...
### DMV - Discovery Fees
```
site:.gov "open records" "fee schedule" "body cam" OR "video" Houston police
```
...
```
site:.gov "ALR" "hearing location" "zoom" OR "telephonic" TX Harris
```
EXTRACT:
