...
```
site:.gov "inmate handbook" "release processing" "shift change" Bexar TX
```
...
```
site:.gov "magistrate" "standing order" "DUI" OR "DWI" "release" Bexar TX
```
...
```
site:.gov "bail schedule" "misdemeanor" "DUI" OR "DWI" 2024 OR 2025 filetype:pdf Bexar TX
```
...
```
site:.gov "bail schedule" "felony" "DUI" OR "DWI" 2024 OR 2025 filetype:pdf Bexar TX
```
EXTRACT:
...
### BAIL - PR Bond Rules
```
site:.gov "personal recognizance" OR "PR bond" "DUI" eligibility Bexar TX
```

### BAIL - Bonding Office Hours
```
site:.gov "Bexar" sheriff "bonding" hours location
```
EXTRACT:
- Address
...
### DMV - Discovery Fees
```
site:.gov "open records" "fee schedule" "body cam" OR "video" San Antonio police
```
...
```
site:.gov "ALR" "hearing location" "zoom" OR "telephonic" TX Bexar
```
EXTRACT:
