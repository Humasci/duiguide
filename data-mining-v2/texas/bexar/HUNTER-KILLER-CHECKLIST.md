# Bexar County, TX - Hunter-Killer v2.0 Research Checklist
...
```
site:.gov "sheriff" "towing" OR "impound" "release procedure" filetype:pdf Bexar TX
```
...
```
site:.gov "towing" "fee schedule" "after hours" OR "holiday" San Antonio Bexar
```
...
```
site:.gov "Bexar" TX "vehicle storage facility" "notarized" OR "power of attorney"
```

### IMPOUND - Fee Schedule
```
site:.gov "towing ordinance" "maximum fee" San Antonio TX
```
...
```
site:.gov "inmate handbook" "release processing" "shift change" Bexar TX 2025
```
...
```
site:.gov "magistrate" "standing order" "DUI" OR "DWI" "release" Bexar TX 2025
```
...
```
site:.gov "bail schedule" "misdemeanor" "DUI" OR "DWI" 2025 filetype:pdf Bexar TX
```
...
```
site:.gov "bail schedule" "felony" "DUI" OR "DWI" 2025 filetype:pdf Bexar TX
```
...
### BAIL - PR Bond Rules
```
site:.gov "personal recognizance" OR "PR bond" "DUI" eligibility Bexar TX 2025
```

### BAIL - Bonding Office Hours
```
site:.gov "Bexar" sheriff "bonding" hours location 2025
```
EXTRACT:
- Address
...
### DMV - Discovery Fees
```
site:.gov "open records" "fee schedule" "body cam" OR "video" San Antonio police 2025
```
...
```
site:.gov "ALR" "hearing location" "zoom" OR "telephonic" TX Bexar 2025
```
EXTRACT:
...
```
site:.gov "probation" "approved providers" "interlock" Bexar TX
```
...
```
site:.gov "interlock" "removal order" OR "verification of removal" form Bexar TX
```
EXTRACT:
...
```
site:.gov "SCRAM" OR "continuous alcohol monitor" "approved" provider Bexar TX
```
EXTRACT:
For each provider:
- Name
...
```
site:.gov "SCRAM violation" "probation revocation" Bexar TX
```
EXTRACT:
...
```
site:.gov "pre-trial intervention" OR "diversion" "contract" OR "agreement" filetype:pdf Bexar TX
```
...
### COURT - Local Rules
```
site:.gov "local rules of practice" "criminal" "cell phone" Bexar clerk
```
...
### COURT - Weekend Jail
```
site:.gov "weekend jail" OR "periodic imprisonment" "application" Bexar sheriff
```
...
### COURT - Parking Hack
```
site:.gov "Bexar" "jury service" parking map
"Bexar" TX courthouse parking juror lot free shuttle
```
